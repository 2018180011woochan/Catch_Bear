...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//
CTexturingSkinnedShader::CTexturingSkinnedShader()
{
}
...
D3D12_INPUT_LAYOUT_DESC CTexturingSkinnedShader::CreateInputLayout()
{
...
D3D12_SHADER_BYTECODE CTexturingSkinnedShader::CreateVertexShader()
{
	return(CShader::CompileShaderFromFile(L"Shaders.hlsl", "VSTexturedSkinning", "vs_5_1", &m_pd3dVertexShaderBlob));
}

D3D12_SHADER_BYTECODE CTexturingSkinnedShader::CreatePixelShader()
{
	return(CShader::CompileShaderFromFile(L"Shaders.hlsl", "PSTexturedSkinning", "ps_5_1", &m_pd3dPixelShaderBlob));
}
