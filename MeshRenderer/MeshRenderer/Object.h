...
public:
	...
	// 2개 이상의 트랙이 enable돼있을 때 가중치를 주면 그 가중치로 보간되어서 변환의 정보가 섞인다
...
public:
	...
	static void LoadBearFromAnimationFile(char* pstrFileName, CLoadedModelInfo* pLoadModel);
...
{
public:
	CTreeObject(ID3D12Device* pd3dDevice, ID3D12GraphicsCommandList* pd3dCommandList, ID3D12RootSignature* pd3dGraphicsRootSignature, CLoadedModelInfo* pModel, int nAnimationTracks);
	virtual ~CTreeObject();
};

//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//
class CBearObject : public CGameObject
{
public:
	CBearObject(ID3D12Device* pd3dDevice, ID3D12GraphicsCommandList* pd3dCommandList, ID3D12RootSignature* pd3dGraphicsRootSignature, CLoadedModelInfo* pModel, int nAnimationTracks);
	virtual ~CBearObject();
};