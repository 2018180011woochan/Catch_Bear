...
void CScene::BuildObjects(ID3D12Device *pd3dDevice, ID3D12GraphicsCommandList *pd3dCommandList)
{
	...
	m_ppGameObjects[0]->SetPosition(316.0f, 230.0f, 650.0f);
	...
	m_ppGameObjects[2] = new CTreeObject(pd3dDevice, pd3dCommandList, m_pd3dGraphicsRootSignature, pTreeModel, 1);
	m_ppGameObjects[2] = pTreeModel->m_pModelRootObject->m_pChild;
	m_ppGameObjects[2]->SetPosition(370.0f, 230.0f, 650.0f);
	m_ppGameObjects[2]->SetScale(1.0f, 1.0f, 1.0f);
	if (pTreeModel) delete pTreeModel;
	...
	//CLoadedModelInfo* pEagleModel2 = CGameObject::LoadGeometryAndAnimationFromTXTFile(pd3dDevice, pd3dCommandList, m_pd3dGraphicsRootSignature, "Model/Tree_01.txt", NULL);
	//m_ppGameObjects[6] = new CEagleObject(pd3dDevice, pd3dCommandList, m_pd3dGraphicsRootSignature, pEagleModel2, 1);
	//m_ppGameObjects[6]->SetPosition(200.0f, m_pTerrain->GetHeight(200.0f, 500.0f), 500.0f);
