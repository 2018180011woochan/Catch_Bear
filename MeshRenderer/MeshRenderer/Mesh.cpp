	...
	for ( ; ; )
	{
		...
		else if (!strcmp(pstrToken, "<UVs>:"))
		{
			...
			if (nUVs)
			{
				...
				//m_pd3dTextureCoord0Buffer = ::CreateBufferResource(pd3dDevice, pd3dCommandList, m_pxmf2TextureCoords0, sizeof(XMFLOAT2) * m_nVertices, D3D12_HEAP_TYPE_DEFAULT, D3D12_RESOURCE_STATE_VERTEX_AND_CONSTANT_BUFFER, &m_pd3dTextureCoord0Buffer);
		...
		else if (!strcmp(pstrToken, "<Normals>:"))
		{
			...
			{
				UINT	nType;
				XMFLOAT3* xmf3Normals;
				nType |= VERTEXT_NORMAL;
				xmf3Normals = new XMFLOAT3[nNormals];
				nReads = (UINT)::fread(xmf3Normals, sizeof(XMFLOAT3), nNormals, pInFile);
		...
		else if (!strcmp(pstrToken, "<Tangents>:"))
		{
			...
			{
				UINT	nType;
				XMFLOAT3* xmf3Tangents;
				nType |= VERTEXT_TANGENT;
				xmf3Tangents = new XMFLOAT3[nTangents];
				nReads = (UINT)::fread(xmf3Tangents, sizeof(XMFLOAT3), nTangents, pInFile);
		...
		else if (!strcmp(pstrToken, "<BiTangents>:"))
		{
			...
			{
				XMFLOAT3* xmf3Tangents;
				xmf3Tangents = new XMFLOAT3[nBiTangents];
				nReads = (UINT)::fread(xmf3Tangents, sizeof(XMFLOAT3), nBiTangents, pInFile);
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//
CTexturedMesh::CTexturedMesh(ID3D12Device* pd3dDevice, ID3D12GraphicsCommandList* pd3dCommandList)
...
void CTexturedMesh::LoadMeshFromFile(ID3D12Device* pd3dDevice, ID3D12GraphicsCommandList* pd3dCommandList, FILE* pInFile)
{
	char pstrToken[64] = { '\0' };
	BYTE nStrLength = 0;
	UINT nReads = 0;
...
void CTexturedMesh::OnPreRender(ID3D12GraphicsCommandList* pd3dCommandList, void* pContext)
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//
CTexturingSkinnedMesh::CTexturingSkinnedMesh(ID3D12Device* pd3dDevice, ID3D12GraphicsCommandList* pd3dCommandList)
	: CMesh(pd3dDevice, pd3dCommandList)
{
}

CTexturingSkinnedMesh::~CTexturingSkinnedMesh()
{
}
...
void CTexturingSkinnedMesh::LoadMeshFromFile(ID3D12Device* pd3dDevice, ID3D12GraphicsCommandList* pd3dCommandList, FILE* pInFile)
{
	char pstrToken[64] = { '\0' };
	BYTE nStrLength = 0;
	UINT nReads = 0;
...
void CTexturingSkinnedMesh::ReleaseUploadBuffers()
{
	CMesh::ReleaseUploadBuffers();
...
void CTexturingSkinnedMesh::OnPreRender(ID3D12GraphicsCommandList* pd3dCommandList, void* pContext)
{
